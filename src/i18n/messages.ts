...
const ro = {
  ...
  report: {
    ...
    offlineError: 'Raportarea necesită conexiune la internet. Reconectează-te și încearcă din nou; raportul nu a fost salvat offline.',
    timeoutError: 'Serverul răspunde prea lent. Verifică dacă raportul a fost trimis înainte de a reîncerca.',
    networkError: 'Conexiunea s-a întrerupt. Verifică internetul și reîncearcă; nu am pus raportul în coadă offline.',
    serverError: 'Serverul nu a putut confirma raportul. Nu este marcat ca trimis; poți reîncerca în siguranță.',
    close: 'Închide',
...
const en: Messages = {
  ...
  report: {
    ...
    offlineError: 'Reporting requires an internet connection. Reconnect and try again; the report was not saved offline.',
    timeoutError: 'The server is taking too long to respond. Check whether the report was sent before trying again.',
    networkError: 'The connection was interrupted. Check your internet and try again; the report was not queued offline.',
    serverError: 'The server could not confirm the report. It is not marked as sent; you can safely try again.',
    close: 'Close',
    submitting: 'Sending…',
    submit: 'Send report',
  },
