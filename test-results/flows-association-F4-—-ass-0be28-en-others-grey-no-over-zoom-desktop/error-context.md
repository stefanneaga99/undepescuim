...
- Name: flows/association.spec.ts >> F4 — association select + highlight >> selecting an association highlights its waters green, others grey, no over-zoom
- Location: tests/e2e/specs/flows/association.spec.ts:14:7
