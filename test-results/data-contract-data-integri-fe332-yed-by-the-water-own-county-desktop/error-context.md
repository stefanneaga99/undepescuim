...
- Name: data-contract/data-integrity.spec.ts >> data contract — real served /public/data @data >> county attribution: geometryByCounty always keyed by the water own county
- Location: tests/e2e/specs/data-contract/data-integrity.spec.ts:65:7

# Error details

```
Error: own-county clip for e4ohjj3a
