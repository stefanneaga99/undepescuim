...
- Name: data-contract/data-integrity.spec.ts >> data contract — real served /public/data @data >> sweep-fixed fixtures carry real geometry, not bbox fallbacks
- Location: tests/e2e/specs/data-contract/data-integrity.spec.ts:51:7

# Error details

```
Error: râul sebesul mijlociu has real geometry
