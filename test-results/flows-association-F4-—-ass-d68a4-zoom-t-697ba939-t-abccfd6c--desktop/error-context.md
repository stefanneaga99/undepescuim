...
- Name: flows/association.spec.ts >> F4 — association select + highlight >> clicking a water outside the association clears the chip but keeps the zoom (t_697ba939/t_abccfd6c)
- Location: tests/e2e/specs/flows/association.spec.ts:56:7
