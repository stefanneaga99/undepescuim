...
For the consolidated result of the latest integrated run, see [Integrated mobile test report](mobile-integrated-test-report.md) and the [run record](mobile-regression-matrix-run-2026-08-20.md), with raw logs under `test-results/mobile-matrix-20260820T171800Z/`.
...
The performance suite also reports request/resource transfer rows, storage/cache metrics, offline transition latency/request isolation, and a baseline delta artifact. See [mobile performance measurement instructions](mobile-performance-measurements.md) and the machine-readable [baseline](mobile-performance-baseline.json).
